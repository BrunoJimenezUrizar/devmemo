module Rapidfire
  class QuestionForm < Rapidfire::BaseService
    AVAILABLE_QUESTIONS =
      ...
      #SOLO DEJAMOS LOS TIPOS DE PREGUNTAS QUE NOS INTERESAN
    ...
    QUESTION_TYPES = AVAILABLE_QUESTIONS.inject({}) do |result, question|
      ...
      if question_name == "Checkbox"
        question_name = "Seleccion Multiple"
      elsif question_name == "Radio"
        question_name = "Seleccion Unica"
      else
        question_name = "Seleccion Unica - Lista"
      end

...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { description: @point.description, location: @point.location, name: @point.name }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { description: @point.description, location: @point.location, name: @point.name }
    assert_redirected_to point_path(assigns(:point))
  end
